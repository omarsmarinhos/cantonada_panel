...
@Component({
  ...
  styleUrl: './menu-edit-modal.component.scss'
})
export class MenuEditModalComponent {
  ...
  constructor() {
    this.form = this.fb.group({
      iIdMenu: [this.menu.iIdMenu],
      tNombre: [this.menu.tNombre, [Validators.required, Validators.pattern(/\S+/)]],
      tEnlace: [this.menu.tEnlace, []],
      tFragmento: [this.menu.tFragmento, [Validators.pattern(/\S+/)]],
      lFragmentoRepetido: [this.menu.lFragmentoRepetido, [Validators.required]],
      lVisible: [this.menu.lVisible, [Validators.required]],
    });
  }
